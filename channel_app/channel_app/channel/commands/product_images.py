...
class SendUpdatedImages(ChannelCommandInterface):
    param_sync = True

    def get_data(self) -> List[ProductImage]:
        product_images = self.objects
...
class SendInsertedImages(SendUpdatedImages):
    pass


class CheckImages(ChannelCommandInterface):
    ...
    def send_request(self, transformed_data) -> object:
        """
        Sends a post request to the channel client to check the images
